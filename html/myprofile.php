    ...
    <div class="row">
      <div class="col-lg-2">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a style="color: #571f70" class="nav-link active" aria-current="page" href="./myprofile.php"><svg
        ...
        <div class="container-fluid">
          ...
          <div class="pic_button">
            <img id="profilepic" width=100
              src="https://dagmarharjutab.files.wordpress.com/2019/02/pexels-photo-555790.jpg" alt="Profile Picture">
            <button id="update_profilepic" type="button">Update Profile Picture</button>
          </div>
