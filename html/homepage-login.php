...
<head>
  ...
  <link href="./css/style2.css" rel="stylesheet">homepage
...
<body>
  ...
  <section class="py-5 container text-left" id="aboutUs">
    ...
    <h4 style="color: #571f70" class="text-center">Based on your preferentes, we suggest a selection of recent discs.
    </h4>
            ...
            <a href="./product.php"><img class="card-img-top" src="./images/u2_pop.png" data-holder-rendered="true"></a>
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                    <button href="#" type="button" style="border-color: #571f70; background-color: #571f70; color: white"
