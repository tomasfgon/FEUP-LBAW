            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a style="color: #571f70" class="nav-link active" aria-current="page"
                        href="admin_manage_users">Manage
                        Users</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a style="color: #571f70" class="nav-link " href="admin_manage_payments">
            ...
            <div class="card" style="border-color: #571f70; background-color: #d9aded; color: 571f70">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="product" class="form-label">Limit Date</label>
                        </div>
                        <div class="col">
                    ...
                    @else
                    <div>
                        There's no manual payment to review.
                    </div>
                    @endif
                    @each('partials.payment', $transfer, 'transfer')
                </div>
            </div>
        </div>
    </div>
