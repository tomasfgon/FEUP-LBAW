                            ...
                            <div class="col-lg-7 mt-2">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="#" name="card" value="card">Credit Card</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#">Paypal</a></li>
                                        <li><a class="dropdown-item" href="#" name="transfer" value="transfer">Bank
                                                Transfer</a></li>
                                    </ul>
                                </div>
                            </div>
