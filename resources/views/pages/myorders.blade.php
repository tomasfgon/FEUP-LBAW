    ...
    <div class="row">
        <div class="col-lg-2">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a style="color: #571f70" class="nav-link" href="../myprofile/myprofile_inventory">
                    Inventory</a>
                </li>
                <li class="nav-item">
                    <a style="color: #571f70" class="nav-link" href="../myprofile/myprofile_my_orders">
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                ...
                                <div class="col">
                                    ...
                                    <div>
                                        <a style="color: #571f70" href="../myprofile/track-order" class="link-primary">Track</a>
                                    </div>
                                    <div>
