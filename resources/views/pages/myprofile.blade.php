  ...
  <div class="row">
    <div class="col-lg-2">
      <ul class="nav flex-column">
        <li class="nav-item">
          <a style="color: #571f70" class="nav-link active" aria-current="page" href="/myprofile"><svg
    ...
    <div class="col-lg-5">
      ...
      <div class="container-fluid">
        <form method="post" action="myprofile/submitUserInfo">
          ...
          <input type="text" id="name" name="name" value="{{session()->get('userinfo')['name']??''}}"><br>
          <label for="address">Address</label><br>

          <input type="text" id="address" name="address" value="{{session()->get('userinfo')['address']??''}}"><br>
